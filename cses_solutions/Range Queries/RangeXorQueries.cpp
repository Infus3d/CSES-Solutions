 ...
 * 
 * However there is special property of xor that makes segment trees
 * reduntant:
 ...
 * 
 * Taking xor nullifies the range [1, a-1] and leaves us with only [a, b].
 * We can calculate the prefix-xors before all queries and answer them in O(1)
 * 
 * Runtime O(n + q)
 * */
#include "bits/stdc++.h"
